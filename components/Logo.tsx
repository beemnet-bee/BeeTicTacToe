    ...
    <div className="flex items-center gap-5 select-none group cursor-default">
      <div className="relative w-14 h-14 flex items-center justify-center">
        ...
        <svg viewBox="0 0 100 100" className="w-full h-full absolute transition-transform duration-700 group-hover:rotate-30">
          ...
          <path 
            ...
            fill="currentColor" 
            className="text-cyan-500 opacity-20 group-hover:opacity-40 transition-opacity" 
          />
          {/* Amber Glow Wing Right */}
          <path 
            d="M50 50 L85 35 L85 65 Z" 
            fill="currentColor" 
            className="text-amber-500 opacity-20 group-hover:opacity-40 transition-opacity" 
          />
        </svg>
        ...
        <div className="relative z-10 w-4 h-8 flex flex-col items-center gap-1">
          {/* Head */}
          <div className="w-3 h-3 bg-white rounded-sm rotate-45 shadow-[0_0_10px_white]"></div>
          {/* Thorax/Body segments */}
          <div className="w-4 h-2 bg-amber-500 rounded-full shadow-[0_0_8px_#f59e0b]"></div>
          <div className="w-4 h-2 bg-zinc-800 rounded-full"></div>
      ...
      <div className="flex flex-col">
        <h1 className="text-4xl font-black tracking-tighter leading-none flex items-baseline">
          ...
          <span className="text-white ml-1.5">TIC-TAC-TOE</span>
        </h1>
        <div className="flex items-center gap-2 mt-1">
          <div className="h-[1px] w-4 bg-amber-500/50"></div>
          <span className="text-[9px] tracking-[0.5em] font-black text-zinc-500 uppercase">Neural Hive Interface</span>
